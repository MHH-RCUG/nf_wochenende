...
nextflow run nf_wochenende.nf  -with-timeline -with-report --ref /mnt/ngsnfs/seqres/metagenref/bwa/2021_12_human_bact_arch_fungi_vir.fa --aligner bwamem --mismatches 5 --mapping_quality mq30 --readType PE  --no_prinseq --no_abra --fastq *R1.fastq
